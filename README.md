...
## Technical
The project is made in Unity version 2021.3.45f2 as it is my preferred LTS release before the changes to the input system. I am using PUN2 for the networking.
